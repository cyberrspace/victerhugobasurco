  ...
  return (
    <article className="card group p-6 md:p-7">
      <div className="flex items-center gap-3">
        ...
        <time dateTime={item.date} className="font-condensed text-[0.62rem] uppercase tracking-[0.18em] text-ash">
      ...
      <p className="mt-3 text-[0.95rem] leading-relaxed text-ash">{item.excerpt}</p>

      {item.quote && (
        <blockquote className="mt-4 border-l-2 border-ember/60 pl-4 font-display text-[1.02rem] italic text-parchment">
